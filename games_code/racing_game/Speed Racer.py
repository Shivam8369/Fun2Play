...
car = pygame.image.load("./games_code/racing_game/data/images/Car.png")
car = pygame.transform.scale(car,(150,150)).convert_alpha()

road = pygame.image.load("./games_code/racing_game/data/images/Road.png")
road = pygame.transform.scale(road,(400,700)).convert_alpha()

sand = pygame.image.load("./games_code/racing_game/data/images/Sand.jpg")
sand = pygame.transform.scale(sand,(150,700)).convert_alpha()

leftDisp = pygame.image.load("./games_code/racing_game/data/images/LeftDisplay.png")
leftDisp = pygame.transform.scale(leftDisp,(250,700)).convert_alpha()

rightDisp = pygame.image.load("./games_code/racing_game/data/images/RightDisplay.png")
rightDisp = pygame.transform.scale(rightDisp,(250,700)).convert_alpha()

tree = pygame.image.load("./games_code/racing_game/data/images/Tree.png")
...
strip = pygame.image.load("./games_code/racing_game/data/images/Strip.png")
strip = pygame.transform.scale(strip,(25,90)).convert_alpha()
stripXY = [[593,0],[593,152.5],[593,305],[593,457.5],[593,610]]

explosion = pygame.image.load("./games_code/racing_game/data/images/Explosion.png")
explosion = pygame.transform.scale(explosion,(290,164)).convert_alpha()

fuel = pygame.image.load("./games_code/racing_game/data/images/Fuel.png")
...
for i in range(1,10):
    CCi = pygame.image.load("./games_code/racing_game/data/images/Coming Cars/"+"CC"+str(i)+".png")
    CCi = pygame.transform.scale(CCi, (75, 158)).convert_alpha()
    comingCars.append([CCi,speedCC[i-1]])
    GCi = pygame.image.load("./games_code/racing_game/data/images/Going Cars/"+"GC"+str(i)+".png").convert_alpha()
...
def gameLoop():
    ...
    pygame.mixer.music.load("./games_code/racing_game/data/audios/lmn.mp3")
    ...
    with open("./games_code/racing_game/data/Highscore.txt","r") as f:
...
def homeScreen():
    ...
    pygame.mixer.music.load("./games_code/racing_game/data/audios/rtn.mp3")
    pygame.mixer.music.play()

    if not os.path.exists("./games_code/racing_game/data/Highscore.txt"):
        with open("./games_code/racing_game/data/Highscore.txt","w") as f:
            f.write("0")
            highscore = 0
    else:
        with open("./games_code/racing_game/data/Highscore.txt","r") as f:
    ...
    background = pygame.image.load("./games_code/racing_game/data/images/Background.png")
